      ...
      <div>
          <div className={"first"}>
              ...
              <div className={"firsthook"}>
                  <svg xmlns="http://www.w3.org/2000/svg" className="svg1 svg1-smaller" width="138" height="81" viewBox="0 0 138 81"
                       fill="none">
                      <path
                  ...
                  <p className={"texto text-smaller"}>{language === 'en' ? 'What song are you listening to?' : '실례지만 어떤 노래들으세요?'}</p>
                  <svg xmlns="http://www.w3.org/2000/svg" className="svg2 svg2-smaller" width="138" height="80" viewBox="0 0 138 80"
                       fill="none">
                      <path
              ...
              <img src={soundbar} className="soundbar soundbar-smaller" alt="logo"/>
